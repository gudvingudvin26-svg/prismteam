...
const Stats: React.FC = () => {
  ...
  const [questionsStats, setQuestionsStats] =
    useState<any[]>([]);
  ...
  const loadQuizStats = async (
    ...
    try {
      ...
      const sessionsResponse =
        await sessionsApi.getSessionsForQuiz(
          quizId
        );
      ...
      sessions.forEach((s: any) => {
        ...
        if (
          ...
          s.status === 'completed' &&
          s.participant_name &&
          s.participant_name !== currentUser
        ) {
          uniqueCompletedSessions.set(
            s.id,
            s
          );
        }
      ...
      const completedSessions =
        Array.from(
          uniqueCompletedSessions.values()
        );
       ...
       * готовую агрегированную статистику
       */
      ...
      if (
        ...
        try {
          ...
          const statsResponse =
            await sessionsApi.getQuestionsStats(
          ...
          console.error(
            'Error fetching questions stats:',
            e
          );
        }
      }
